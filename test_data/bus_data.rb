module Bus
  ...
  RESELLER_TYPE = {:silver => "Silver Reseller", :gold => "Gold Reseller", :platinum => "Platinum Reseller" }

  MOZY_ROOT_PARTNER = { :mozypro => "MozyPro", :mozypro_france => "MozyPro France", :mozypro_germany => "MozyPro Germany",:mozypro_ireland => "MozyPro Ireland",:mozypro_uk => "MozyPro UK" }
