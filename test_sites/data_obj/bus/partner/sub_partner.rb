module Bus
  module DataObj
    ...
    class SubPartner
      ...
      #
      def initialize(hash)
        default = {company_name:"#{Forgery::Name.company_name} Sub Partner #{Time.now.strftime("%m%d-%H%M-%S")}", admin_name:Forgery::Name.full_name, admin_email_address:create_user_email, security:'NONE'}
