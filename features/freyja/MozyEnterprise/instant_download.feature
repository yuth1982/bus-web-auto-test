Feature: Instant Download
  ...
  @TC.121723 @freyja  @freyja_smoke  @ent  @ent_instant_download_Sync_file    @ent_instant_download   @ent_smoke @QA12 @QA6
  ...
  @TC.121723 @freyja @freyja_smoke   @ent  @ent_instant_download_Sync_folder   @ent_instant_download  @ent_smoke @QA12 @QA6
