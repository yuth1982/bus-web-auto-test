Feature: Restore All Files
  ...
  @TC.121719 @freyja @freyja_smoke  @ent_restore_all_fryr @ent_restore_all @ent_smoke @QA12 @QA6
  ...
  @TC.121719 @freyja @freyja_smoke  @ent  @ent_restore_all_archive @ent_restore_all @ent_smoke @QA12 @QA6
