Feature: Restore All Files
  ...
  @freyja @freyja_smoke  @ent  @ent_restore_all_fryr @ent_restore_all
...
@freyja @freyja_smoke  @ent  @ent_restore_all_archive @ent_restore_all
...
@freyja @freyja_smoke @ent  @ent_restore_all_media @ent_restore_all
