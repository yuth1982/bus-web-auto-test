Feature: Restore All Files
  ...
  @freyja @smoke  @ent  @ent_restore_all_fryr @ent_restore_all
...
@freyja @smoke  @ent  @ent_restore_all_archive @ent_restore_all
...
@freyja @smoke @ent  @ent_restore_all_media @ent_restore_all
