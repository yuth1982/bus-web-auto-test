Feature: Restore Manager Restore
  ...
  @freyja  @ent  @ent_restore_manager_restore_one_file      @ent_restore_manager_restore
...
@freyja  @ent  @ent_restore_manager_restore_one_folder        @ent_restore_manager_restore
  Scenario: MozyEnterprise user restore one file through restore manager in Freyja
    When I select the Devices tab
