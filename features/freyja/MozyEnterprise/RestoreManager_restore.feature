Feature: Restore Manager Restore
  ...
  @TC.121725  @freyja @freyja_smoke  @ent  @ent_restore_manager_restore_one_file      @ent_restore_manager_restore  @ent_smoke @QA12 @QA6
Scenario: MozyEnterprise user restore one file through restore manager in Freyja
 ...
 @TC.121725  @freyja @freyja_smoke  @ent  @ent_restore_manager_restore_one_folder        @ent_restore_manager_restore  @ent_smoke @QA12 @QA6
  Scenario: MozyEnterprise user restore one file through restore manager in Freyja
    When I select the Devices tab
