Feature: Restore files in Restore Queue
  ...
  @TC.121715 @freyja @freyja_smoke @ent  @ent_add_remove_files_restore_queue @ent_smoke
...
@TC.121715 @freyja @freyja_smoke @ent  @ent_instant_restore_files_restore_queue  @ent_smoke
Scenario: MozyEnterprise user instant download files in Restore Queue from Freyja
  When I select options menu
  And I select Preferences
  And I choose Yes for restore queue
...
@TC.121715 @freyja @freyja_smoke @ent  @ent_Fryr_restore_files_restore_queue @ent_smoke
...
@TC.121715 @freyja @freyja_smoke @ent  @ent_archive_restore_files_restore_queue  @ent_smoke
...
@TC.121715 @freyja @freyja_smoke @ent  @ent_media_restore_files_restore_queue  @ent_smoke
