Feature: Restore files in Restore Queue
  ...
  @TC.121715 @freyja @freyja_smoke @ent  @ent_add_remove_files_restore_queue @ent_smoke  @ent_restore_queue
...
@TC.121715 @freyja @freyja_smoke @ent  @ent_archive_restore_files_restore_queue  @ent_smoke   @ent_restore_queue
