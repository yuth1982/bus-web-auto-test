Feature: Restore files in Restore Queue
  ...
  @freyja @ent  @ent_add_remove_files_restore_queue
...
@freyja @ent  @ent_Fryr_restore_files_restore_queue
...
@freyja @ent  @ent_archive_restore_files_restore_queue
...
@freyja @ent  @ent_media_restore_files_restore_queue
