Feature: Localization login and restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_instant_restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_restore_manager_restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_archive_restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_media_restore
