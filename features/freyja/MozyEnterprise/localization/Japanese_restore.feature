Feature: Localization login and restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_instant_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_restore_manager_restore  @ent_smoke
  Scenario: MozyEnterprise user Japanese localization login and restore manager restore
    ...
    When I select options menu
    And I select event history
    Then this restore is test
    When I select options menu
    And I logout

  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_archive_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Japanese @ent_localization_Japanese_media_restore  @ent_smoke
