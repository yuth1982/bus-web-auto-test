Feature: Localization login and restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Portugues @ent_localization_Portugues_instant_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Portugues @ent_localization_Portugues_restore_manager_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Portugues @ent_localization_Portugues_archive_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Portugues @ent_localization_Portugues_media_restore  @ent_smoke
