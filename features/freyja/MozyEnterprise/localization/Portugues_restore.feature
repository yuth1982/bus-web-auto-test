Feature: Localization login and restore
  ...
  @TC. @freyja @freyja_smoke @ent1 @ent_localization @ent_localization_Portugues @ent_localization_Portugues_instant_restore @QA12 @QA6
...
#    And I logout
  ...
  @TC. @freyja @freyja_smoke @ent1 @ent_localization @ent_localization_Portugues @ent_localization_Portugues_restore_manager_restore @QA12 @QA6
...
#    And I logout
  ...
  @TC. @freyja @freyja_smoke @ent1 @ent_localization @ent_localization_Portugues @ent_localization_Portugues_archive_restore @QA12 @QA6
...
#    And I logout
  ...
  @TC. @freyja @freyja_smoke @ent1 @ent_localization @ent_localization_Portugues @ent_localization_Portugues_media_restore  @QA12 @QA6
