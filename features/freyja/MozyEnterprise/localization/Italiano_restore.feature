Feature: Localization login and restore
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Italiano @ent_localization_Italiano_instant_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Italiano @ent_localization_Italiano_restore_manager_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Italiano @ent_localization_Italiano_archive_restore  @ent_smoke
  ...
  @TC. @freyja @freyja_smoke  @ent  @ent_localization @ent_localization_Italiano @ent_localization_Italiano_media_restore  @ent_smoke
