Feature: Private Key user Restore Files
  ...
  @freyja @freyja_smoke  @ent  @ent_restore_all_fryr_ckey @ent_restore_ckey
  ...
  @freyja @freyja_smoke  @ent  @ent_restore_one_file_archive_ckey @ent_restore_ckey
  ...
  @freyja @freyja_smoke @ent @ent_restore_all_media_ckey @ent_restore_ckey
...
@freyja  @freyja_smoke  @ent  @ent_instant_download_Sync_file_ckey  @ent_restore_ckey
