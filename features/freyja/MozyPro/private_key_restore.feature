Feature: Private Key user Restore Files
  ...
  @freyja  @pro  @pro_restore_all_fryr_pk @pro_restore_pk
  ...
  @freyja  @pro  @pro_restore_all_archive_pk @pro_restore_pk
  ...
  @freyja @pro @pro_restore_all_media_pk @pro_restore_pk
...
@freyja   @pro  @ent_instant_download_Sync_file_pk  @pro_restore_pk
