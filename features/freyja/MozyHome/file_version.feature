Feature: File Versions
  ...
  @freyja  @home  @home_view_download_sync_file_versions
...
@freyja  @home  @home_view_download_backup_file_versions @home_view_instant_download_backup_file_versions
  Scenario: home user view file versions in Sync container
...
@freyja  @home  @home_view_download_backup_file_versions @home_view_Fryr_download_backup_file_versions
Scenario: home user view file versions in Sync container
  When I select the Devices tab
  And I choose one file with versions
  And I open Actions panel
...
@freyja  @home  @home_view_download_backup_file_versions @home_view_archive_download_backup_file_versions
  Scenario: home user view file versions in Sync container
    When I select the Devices tab
    And I choose one file with versions
    And I open Actions panel
  ...
  @freyja  @home  @home_view_download_backup_file_versions @home_view_media_download_backup_file_versions
  Scenario: home user view file versions in Sync container
    When I select the Devices tab
    And I choose one file with versions
    And I open Actions panel
