Feature: File Versions
  ...
  @freyja @smoke  @home  @home_view_download_sync_file_versions
...
@freyja  @smoke @home  @home_view_download_backup_file_versions @home_view_instant_download_backup_file_versions
  Scenario: home user view file versions in Sync container
...
@freyja  @smoke @home  @home_view_download_backup_file_versions @home_view_Fryr_download_backup_file_versions
Scenario: home user view file versions in Sync container
  When I select the Devices tab
  And I choose one file with versions
  And I open Actions panel
...
@freyja @smoke  @home  @home_view_download_backup_file_versions @home_view_archive_download_backup_file_versions
  Scenario: home user view file versions in Sync container
    When I select the Devices tab
    And I choose one file with versions
    And I open Actions panel
  ...
  @freyja @smoke  @home  @home_view_download_backup_file_versions @home_view_media_download_backup_file_versions
  Scenario: home user view file versions in Sync container
    When I select the Devices tab
    And I choose one file with versions
    And I open Actions panel
