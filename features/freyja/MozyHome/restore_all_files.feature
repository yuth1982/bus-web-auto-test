Feature: Restore All Files
  ...
  @freyja @smoke  @home  @home_restore_all_fryr @home_restore_all
...
@freyja @smoke  @home  @home_restore_all_archive @home_restore_all
...
@freyja @smoke @home @home_restore_all_media @home_restore_all
