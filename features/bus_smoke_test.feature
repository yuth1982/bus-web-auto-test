Feature: These are the test we run for every deploy
  ...
  @bus_smoke @TC.20
  Scenario: 20 BUS - US MozyPro smoke test
    #Prod 20 Log into BUS
    Given I log in bus admin console as administrator

  @bus_smoke @TC.21
  Scenario: 21 BUS - US MozyPro smoke test
    #Prod 21
    ...
    And Partner pooled storage information should be:
      | Used | Available | Assigned | Used | Available | Assigned  |
      | 0    | 10        | 10       | 1    | Unlimited | Unlimited |

  @bus_smoke @TC.22
  Scenario: 22 BUS - US MozyPro smoke test
    #Prod 22
...
#      | Total amount to be charged    | $273.00  |
  ...
  @bus_smoke @TC.180
  Scenario: 180 BUS - US MozyPro smoke test
    When I search partner by MozyPro BUS Smoke Test
    And I view partner details by MozyPro BUS Smoke Test
    #Prod-180.2
    And Partner pooled storage information should be:
  ...
  @bus_smoke @TC.73
  Scenario: 73 BUS - US MozyPro smoke test
    When I search partner by MozyPro BUS Smoke Test
    And I view partner details by MozyPro BUS Smoke Test
    #Prod 73
  ...
  @bus_smoke @TC.23
  Scenario: 23 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
    #Prod 23
  ...
  @bus_smoke @TC.24
  Scenario: 24 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
  ...
  @bus_smoke @TC.26
  Scenario: 26 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
    When I navigate to Search / List Users section from bus admin console page
    And I view user details by user without stash
    #Prod 26 move the user from none user group to a different user group
    But I reassign the user to user group omega
    Then the user's user group should be omega
    When I close user details section

  @bus_smoke @TC.179
  Scenario: 179 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
    And I add new user(s):
      | name            | user_group | storage_type | storage_limit | devices | enable_stash |
      | user with stash | omega      | Desktop      | 10            | 3       | yes          |
    Then 1 new user should be created
    When I navigate to Search / List Users section from bus admin console page
  ...
  @bus_smoke @TC.31
  Scenario: 31 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
    #Prod 31 - Run report
    ...
    Then Scheduled Billing Detail report csv file details should be:
      ...
      | @name    | (default user group)  |              | Shared             | N/A                         | N/A                         | 0                      | 0                     | 0                     | 0                                      | N/A                          | N/A                          | 0                       | 0                      | 0                      | 0                                       |                                    |                                     | $0.54                  |
      | @name    | alpha                 |              | Shared             | N/A                         | N/A                         | 0                      | 0                     | 0                     | 0                                      | N/A                          | N/A                          | 0                       | 1                      | 0                      | 0                                       |                                    |                                     | $0.54                  |
      | @name    | omega                 |              | Limited: 20        | N/A                         | N/A                         | 0                      | 0                     | 0                     | 0                                      | N/A                          | N/A                          | 0                       | 3                      | 0                      | 3                                       |                                    |                                     | $0.54                  |
  ...
  @bus_smoke @TC.25
  Scenario: 25 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
  ...
  @bus_smoke @TC.27
  Scenario: 27 BUS - US MozyPro smoke test
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
  ...
  @bus_smoke @TC.89
  Scenario: 89 BUS - US MozyPro smoke test
  ...
  @bus_smoke @TC.198
  Scenario: 198 BUS - US MozyEnterprise smoke test
    #Prod 198
  ...
  @bus_smoke @TC.69
  Scenario: 69 BUS - US MozyEnterprise smoke test
...
#      | dev-17538-test1@test.com | dev-17538-test1 | dev        |
  ...
  @bus_smoke @TC.199
  Scenario: 199 BUS - US MozyFortress smoke test
    #Prod 199
    When I act as partner by:
  ...
  @bus_smoke @TC.121283
  Scenario: 121283 BUS - US MozyOEM smoke test
    #Prod 199
  ...
  @bus_smoke @TC.181
  Scenario: 181 BUS - US MozyFortress smoke test
   #Prod 181
    When I act as partner by:
      | name                             |
      | Internal Mozy OEM BUS Smoke Test |
  ...
  Scenario: 178 BUS - US MozyPro smoke test data shuttle
    When I act as partner by:
      | name                   |
      | MozyPro BUS Smoke Test |
    #Prod 178 search/list machines
    When I navigate to Search / List Machines section from bus admin console page
    Then Search list machines section is opened

  @bus_smoke @TC.377 @qa
  Scenario: 377 BUS - US MozyPro smoke test data shuttle
    #Prod 377 order data shuttle
    When I order data shuttle for MozyPro BUS Smoke Test
      | power adapter   | key from  | quota |
      | Data Shuttle US | available | 20    |
    Then Data shuttle order should be created

  @bus_smoke @TC.378 @qa
  Scenario: 378 BUS - US MozyPro smoke test data shuttle
    When I search order in view data shuttle orders section by MozyPro BUS Smoke Test
    And I view data shuttle order details
    #Prod 378 update data shuttle
  ...
  @bus_smoke @TC.74
  Scenario: 74 BUS - US MozyPro smoke test
    #Prod 74 Log into BUS
    Given I log in bus admin console as administrator

  @emea_smoke @TC.75
  Scenario: 75 BUS - EMEA smoke test
  ...
  @emea_smoke @TC.76
  Scenario: 76 BUS - EMEA smoke test
  ...
  @emea_smoke @TC.77
  Scenario: 77 BUS - EMEA smoke test
    #Prod 77 Masquerade into the partner
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |

  @emea_smoke @TC.78
  Scenario: 78 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
  ...
  @emea_smoke @TC.86
  Scenario: 86 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
    When I add a new Bundled user group:
  ...
  @emea_smoke @TC.79
  Scenario: 79 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
  ...
  @emea_smoke @TC.80
  Scenario: 80 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
  ...
  @emea_smoke @TC.81
  Scenario: 81 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
  ...
  @emea_smoke @TC.85
  Scenario: 85 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
    And  I navigate to Search / List Users section from bus admin console page
  ...
  @emea_smoke @TC.82
  Scenario: 82 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
  ...
  @emea_smoke @TC.84
  Scenario: 84 BUS - EMEA smoke test
    When I act as partner by:
      | name                          |
      | MozyPro France BUS Smoke Test |
    #Prod 84 - Run report
  ...
  @bus_smoke @TC.90
  Scenario: 90 BUS - US MozyPro smoke test
  ...
  @emea_smoke @TC.379 @qa
  Scenario: 379 BUS - EMEA smoke test data shuttle
    #Prod 379 order data shuttle
    When I order data shuttle for MozyPro France BUS Smoke Test
      | power adapter     | key from  | quota |
      | Data Shuttle EMEA | available | 10    |
    Then Data shuttle order should be created

  @emea_smoke @TC.378 @qa
  Scenario: 378 BUS - EMEA smoke test
    When I search order in view data shuttle orders section by MozyPro France BUS Smoke Test
    And I view data shuttle order details
    #Prod 378 update data shuttle
    And I add drive to data shuttle order
    Then Add drive to data shuttle order message should include Successfully added drive to order
  ...
  @emea_smoke @TC.365
  Scenario: 365 BUS - EMEA smoke test with VAT Number
    When I add a new MozyPro partner:
