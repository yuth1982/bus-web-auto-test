...
#  * Partner settings, Client Controller (get_config)
  ...
  @TC.120809 @retention @environment_dependent @partner_setting
  ...
  @TC.120810 @retention @environment_dependent @partner_setting
  ...
  @TC.120811 @retention @environment_dependent @partner_setting
