...
Feature: Manage Horizon related settings
  ...
  @TC.17470 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
  ...
  @TC.17471 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
  ...
  @TC.17472 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
  ...
  @TC.17473 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
  ...
  @TC.17474 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
  ...
  @TC.17475 @bus @2.1 @direct_ldap_integration @authentication_migration @qa5
