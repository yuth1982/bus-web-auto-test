...
Feature: Proxy for LDAP queries
  ...
  @FID11.1006 @TC.19194 @bus @2.3 @direct_ldap_integration @proxy @adfs @qa5 @need_test_account @env_dependent
  ...
  @FID11.1006 @TC.19196 @bus @2.3 @direct_ldap_integration @proxy @adfs @qa5 @need_test_account @env_dependent
