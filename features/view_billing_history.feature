Feature: View billing history
  ...
  Scenario: Display billing history table header in partner details view
    ...
    Then The statements table header in partner details view should be Date Amount Total Paid Balance Due Invoice Number
  ...
  Scenario: Display billing statement table header of existing in billing history view
    Given I log in bus admin console as polly kuhn admin
    When I navigate to billing history view
    Then The statements table header in billing history view should be Date Amount Total Paid Balance Due Invoice Number
