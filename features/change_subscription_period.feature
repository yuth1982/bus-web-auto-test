Feature: Change subscription period
  ...
  @TC.15231 @change_subscription_period @smoke_test
  ...
  @TC.15232 @change_subscription_period
  Scenario: Mozy-15232 Move upstream with subscription period (MozyPro / Yearly -> Biennially)
    When I add a MozyPro partner with 12 month(s) period, 500 GB, $2,089.89 plan, no server plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15233 @change_subscription_period
  Scenario: Mozy-15233 Move upstream with subscription period (MozyPro / Monthly -> Biennially)
    When I add a MozyPro partner with 1 month(s) period, 1 TB, $379.99 plan, no server plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15234 @change_subscription_period @smoke_test
  Scenario: Mozy-15234 Move downstream with subscription period (MozyPro / Biennially -> Yearly)
    When I add a MozyPro partner with 24 month(s) period, 50 GB, $419.79 plan, no server plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15235 @change_subscription_period
  Scenario: Mozy-15235 Move downstream with subscription period (MozyPro / Yearly -> Monthly)
    When I add a MozyPro partner with 12 month(s) period, 100 GB, $439.89 plan, no server plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15236 @change_subscription_period
  Scenario: Mozy-15236 Move downstream with subscription period (MozyPro / Biennially -> Monthly)
    When I add a MozyPro partner with 24 month(s) period, 10 GB, $209.79 plan, no server plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15238 @change_subscription_period @smoke_test
  ...
  @TC.15239 @change_subscription_period
  Scenario: Mozy-15239 Move upstream with subscription period (MozyEnterprise / Biennially -> 3 Years)
    When I add a MozyEnterprise partner with 24 month(s) period, 1 user(s), None add-on plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15240 @change_subscription_period
  ...
  @TC.15241 @change_subscription_period
  ...
  @TC.15243 @change_subscription_period
  Scenario: Mozy-15243 Move downstream with subscription period (MozyEnterprise / 3 Years -> Biennially)
    When I add a MozyEnterprise partner with 36 month(s) period, 1 user(s), None add-on plan
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15244 @change_subscription_period
  ...
  @TC.15245 @change_subscription_period
  ...
  @TC.15246 @change_subscription_period
  Scenario: Mozy-15246 Move downstream with subscription period (Reseller / Monthly -> Yearly)
    When I add a Reseller partner with 12 month(s) period, Gold Reseller, 500 GB plan, has server plan, 10 add-on
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
  ...
  @TC.15253 @change_subscription_period
  Scenario: Mozy-15253 Verify MozyPro partner master plan section details
    ...
    And Next renewal master plan amount should be $94.99
  ...
  Scenario: Mozy-15253 Verify MozyPro partner master plan section details
    ...
    And Next renewal master plan amount should be $259.00
    And Next renewal master plan payment type should be Visa ending in 1111 (change)

  @TC.15254 @not_done
  Scenario: Mozy-15254 Verify VAT information in the billing information view
    When I add a MozyPro partner with 1 month(s) period, 50 GB, $19.99 plan, no server plan, Belgium country, BE0883236072 VAT number
    Then Partner creation successful message should be New partner created
    When I masquerade as the new partner
    And I navigate to billing information view
  ...
  #Scenario: Verify MozyPro partner supplemental plan section details
  #  Given I log in bus admin console as MozyPro 250 GB Plan (Monthly) test partner
  #  And I navigate to billing information view
  #  Then Next renewal plan details should be:
  #  | description             | price   |
