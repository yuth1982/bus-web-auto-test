...
When /^I click reset password link from the email$/ do
  ...
  match = @mail_content.match(/https?:\/\/(mozy|secure\.mozy)\.com\/[\S]+\/pass/)||@mail_content.match(/https?:\/\/(www\.mozypro|resetpassword\.mozypro|osngbedo\.mozypro)\.com\/[\S]+\/pass\/\?pid=[\d]+/)
