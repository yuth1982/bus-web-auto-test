Feature: Add a new user
  ...
  Scenario: 20875 [Bundled] Add New User with default user group
    ...
    Then User search results should be:
      ...
      | TC.20875-1  | (default user group)  | Enabled  | 10 GB(Max) |
      | TC.20875-2  | (default user group)  | Disabled | Shared     |
      | TC.20875-3  | (default user group)  | Disabled | 10 GB(Max) |
  ...
  Scenario: 20910 [Bundled] Add New User with new user group
    ...
    Then User search results should be:
      | Name        | User Group     | Stash    | Storage    |
      | TC.20910-1  | TC.20910 UG 1  | Enabled  | 10 GB(Max) |
      | TC.20910-2  | TC.20910 UG 1  | Disabled | Shared     |
      | TC.20910-3  | TC.20910 UG 2  | Disabled | 10 GB(Max) |
  ...
  Scenario: 20871 [Itemized] Add New User with default user group
    ...
    Then User search results should be:
      | Name        | User Group            | Stash    | Storage    |
      | TC.20871-1  | (default user group)  | Enabled  | 10 GB(Max) |
      | TC.20871-2  | (default user group)  | Disabled | Shared     |
      | TC.20871-3  | (default user group)  | Disabled | 10 GB(Max) |
  ...
  Scenario: 20906 [Itemized] Add New User with new user group
    ...
    Then User search results should be:
      | Name        | User Group     | Stash    | Storage    |
      | TC.20906-1  | TC.20906 UG 1  | Enabled  | 10 GB(Max) |
      | TC.20906-2  | TC.20906 UG 1  | Disabled | Shared     |
      | TC.20906-3  | TC.20906 UG 2  | Disabled | 10 GB(Max) |
  ...
  Scenario: 20921 [MozyPro] Add New User
    ...
    Then User search results should be:
      | Name        | Stash    | Storage    |
      | TC.20921-1  | Enabled  | 10 GB(Max) |
      | TC.20921-2  | Disabled | Shared     |
      | TC.20921-3  | Disabled | 10 GB(Max) |
