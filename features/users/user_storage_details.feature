...
#    And I act as newly created partner
  ...
  @TC.19844 @bus @user_storage_details @enterprise @server @regression @core_function
...
@TC.19850 @bus @user_storage_details @emea @IE @bundled @server @regression @core_function
...
@TC.19853 @bus @user_storage_details @emea @UK @enterprise @stash @regression @core_function
...
@TC.19856 @bus @user_storage_details @emea @FR @metallic_reseller @server @regression @core_function
