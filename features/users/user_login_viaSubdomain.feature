Feature: user login via subdomain
  ...
  @TC.133411 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133412 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133413 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133414 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133415 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133416 @bus @user @user_login_via_subdomain @regression
  Scenario: 133416:L1 Partner 's user can login successfully via *.mozy.com of partner root under mozypro
    When I go to page https://autotestsubdomainpro.mozy.com/login/user
    And I log in bus admin console with user name mozyautotest+l1subuser+subdomain@emc.com and password QAP@SSw0rd
    Then I will see the user account page

  @TC.133417 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133418 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133421 @bus @user @user_login_via_subdomain @regression
  ...
  @TC.133422 @bus @user @user_login_via_subdomain @regression
