Feature: Login bus admin console
  ...
  Scenario: 120658 Standard admin log into BUS with upper/mixed case username
    When I navigate to bus admin console login page
    Then I log into bus admin console with uppercase Standard admin
    And I log out bus admin console
    Then I navigate to bus admin console login page
    And I log into bus admin console with mixed case Standard admin
    And I log out bus admin console

  @TC.120659 @bus @log_in_screen
  Scenario: 120659 Hipaa admin log into BUS with upper/mixed case username
    When I navigate to bus admin console login page
    Then I log into bus admin console with uppercase Hipaa admin
    And I log out bus admin console
    Then I navigate to bus admin console login page
    And I log into bus admin console with mixed case Hipaa admin
    And I log out bus admin console
  ...
  Scenario: 120660 Standard user log into BUS with upper/mixed case username
    ...
    Then I log into Standard subdomain with uppercase username Standard user
    And I log out user
    Then I log into Standard subdomain with mixed case username Standard user
    And I log out user
  ...
  Scenario: 120661 Hipaa user log into BUS with upper/mixed case username
    ...
    Then I log into Hipaa subdomain with uppercase username Hipaa user
    And I log out user
    Then I log into Hipaa subdomain with mixed case username Hipaa user
    And I log out user
