Feature: Add a new partner
  ...
  Scenario: Add a new monthly MozyPro european country partner
   When I add a MozyPro partner with 1 month(s) period, 100 GB, $39.99 plan, no server plan, no coupon, United Kingdom country, no VAT number, credit card payment
   Then Order summary table should be:
   | Column A          | Column B | Column C   | Column D    |
   | Description       | Quantity | Price Each | Total Price |
  ...
  Scenario: Add a new MozyPro partner with net terms payment
    When I add a MozyPro partner with 12 month(s) period, 500 GB, $2,089.89 plan, has server plan, no coupon, net terms payment
    Then Partner created successful message should be New partner created.
  ...
  Scenario: Add a new yearly Gold Reseller european country partner
    When I add a Reseller partner with 12 month(s) period, Platinum Reseller, 100 GB plan, has server plan, 1 add-on, no coupon, United Kingdom country, no VAT number, credit card payment
    Then Order summary table should be:
    | Column A               | Column B | Column C   | Column D    |
    | Description            | Quantity | Price Each | Total Price |
  ...
  Scenario: Add a new Gold Reseller partner with vat and coupon
    When I add a Reseller partner with 12 month(s) period, Gold Reseller, 100 GB plan, has server plan, 1 add-on, Coupon5DollarsOff coupon, Italy country, IT03018900245 VAT number, credit card payment
    Then Order summary table should be:
    | Column A              | Column B | Column C   | Column D    |
    | Description           | Quantity | Price Each | Total Price |
    ...
    | Discounts Applied     |          |            | $-5.00      |
    | Pre-tax Subtotal      |          |            | $1,167.50   |
    | Total Charges         |          |            | $1,167.50   |
    Then Partner created successful message should be New partner created.
