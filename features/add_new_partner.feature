Feature:
  ...
  I want to create sub partners under my partner
  ...
  Scenario: Add a new MozyEnterprise partner
    When I add a MozyEnterprise partner with 12 month(s) period, 1 user(s), 100 GB Server Plan, $582.78 add-on plan
    Then Partner created message should be New partner created.
