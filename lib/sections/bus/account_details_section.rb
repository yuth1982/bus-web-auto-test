module Bus
  ...
  class AccountDetailsSection < PageObject
    ...
    #
    # Example
    #   @bus_admin_console_page.account_details_section.acc_details_desc_column_text
    ...
    #
    # Example
    #   @bus_admin_console_page.account_details_section.acc_details_value_column_text
