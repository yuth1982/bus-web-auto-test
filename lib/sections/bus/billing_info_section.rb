module Bus
  ...
  class BillingInfoSection < PageObject
    ...
    # Example
    #
    #  @bus_admin_console_page.billing_info_section.next_renewal_tb_rows_text
    ...
    # Example
    #
    #  @bus_admin_console_page.billing_info_section.supp_plan_tb_rows_text
    ...
    # Example
    #
    #  @bus_admin_console_page.billing_info_section.vat_tb_rows_text
    ...
    # Example
    #
    #  @bus_admin_console_page.billing_info_section.next_renewal_text_align_css
    #  # => "left"
    #
